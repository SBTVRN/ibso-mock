package ru.sbt.drtmn.lab.dao.spring;
 ...
 * 
 * <pre>
 * &lt;bean class=&quot;ru.sbt.drtmn.lab.dao.spring.HibernateExtensionPostProcessor&quot;&gt;
 *     &lt;property name=&quot;mappingResources&quot;&gt;
 *         &lt;list&gt;
 *             &lt;value&gt;ru/sbt/drtmn/lab/model/Foo.hbm.xml&lt;/value&gt;
 *         &lt;/list&gt;
 *     &lt;/property&gt;
 *     &lt;property name=&quot;annotatedClasses&quot;&gt;
 *         &lt;list&gt;
 *             &lt;value&gt;ru.sbt.drtmn.lab.model.Bar&lt;/value&gt;
 *         &lt;/list&gt;
 *     &lt;/property&gt;
 * &lt;/bean&gt;
 * </pre>
 ...
 * applicationContext.xml at the root level, then the standard AppFuse configuration will automatically pick up the
...
public class HibernateExtensionPostProcessor implements BeanFactoryPostProcessor {
    private static Logger logger = Logger.getLogger(HibernateExtensionPostProcessor.class);
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory configurableListableBeanFactory)  {
        if (configurableListableBeanFactory.containsBean(sessionFactoryBeanName)) {
            ...
            if (mappingResources != null) {
                logger.debug("mappingResource in " + sessionFactoryBeanName + " is not null ");
            ...
            if (annotatedClasses != null) {
                logger.debug("annotated classes is not null ");
            ...
            if (configLocations != null) {
                logger.debug("config location is not null ");
            ...
            if (hibernateProperties != null) {
                logger.debug("hibernate properties is not null ");
            ...
            NoSuchBeanDefinitionException ex = new NoSuchBeanDefinitionException("No bean named [" + sessionFactoryBeanName
