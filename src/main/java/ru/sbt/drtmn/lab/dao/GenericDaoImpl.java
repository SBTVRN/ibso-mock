 ...
 *          &lt;constructor-arg value="ru.sbt.drtmn.lab.model.Foo"/&gt;
 *      &lt;/bean&gt;
 * </pre>
 *
...
public class GenericDaoImpl<T, PK extends Serializable> implements GenericDao<T, PK> {
    ...
    public List<T> search(String searchTerm) throws SearchException {
        ...
        try {
            ...
            logger.debug("Search Query generated " + qry);
        } catch (ParseException ex) {
            logger.error("Parse exception when generating query", ex);
     ...
     */
    public void reindex() {
        SearchTools.reindex(persistentClass, getSessionFactory().getCurrentSession());
    }
    ...
    public void reindexAll(boolean async) {
        SearchTools.reindexAll(async, getSessionFactory().getCurrentSession());
    }
